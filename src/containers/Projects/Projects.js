    ...
    projects: [
      {
        ...
        summary: `I wanted to make a real time web-app so I used Cloud Firebase to store messages from different users. This allows you to send and get messages from friends in real time. I used Material UI for making form and button of this project`,
      ...
      {
        name: "Netflix-clone",
        summary: `In this project, I used TMDb API to make a Netflix clone. This website introduces movies on Netflix and other categories. Also I used React-youtube and movie-trailer to display trailer of chosen film`,
      ...
      {
        name: "Burger-app",
        summary: `For this project I worked with things like Authentication with JSON Web Token and Firebase, I used ReactJs to make the project a Single Page Application. This app is an burger order app with four options of ingredients. Contact of customers will be uploaded on firebase real time database once they confirm their order and they can also follow their orders`,
        skills: ["html & css", "reactjs", "redux", "firebase"],
        img: <img src="/img/burger-app.jpg" alt="burger-app"></img>,
      ...
      {
        name: "Portfolio",
        summary: `The idea behind this project was to create a showcase of some of my projects for the past few months. I tried to keep the UI as simple as possible without any fluff. This is a Single Page Application and is built using ReactJs and CSS`,
        skills: ["html & css", "JavaScript", "reactjs", "responsive"],
        img: <img src="/img/loctran.png" alt="portfolio"></img>,
